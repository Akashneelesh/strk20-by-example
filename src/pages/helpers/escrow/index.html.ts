...
export const githubLink =
  "https://github.com/starkware-libs/starknet-privacy/blob/main/packages/escrow/src/escrow.cairo"
...
<code>buildClaimUrl</code> — see the SDK section for the TypeScript side of this flow.</p>
`
