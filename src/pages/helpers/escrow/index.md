...
title: Escrow
version: 0.14.2
description: A deferred-delivery escrow helper contract - send privately to someone who has not registered yet
keywords: [escrow, helper, commitment, claim, secret, privacy_invoke]
githubLink: https://github.com/starkware-libs/starknet-privacy/blob/main/packages/escrow/src/escrow.cairo
---
...
`buildClaimUrl` — see the SDK section for the TypeScript side of this flow.
